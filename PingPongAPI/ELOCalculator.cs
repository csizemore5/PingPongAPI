...
namespace PingPongAPI
{
    public class ELOCalculator
    {
        ...
        public ELOCalculator(double ratingA, double ratingB, double scoreA, double scoreB)
        {
        ...
        */
        ...
        public ELOCalculator SetNewSettings(double ratingA, double ratingB, double scoreA, double scoreB)
        {
            _ratingA = ratingA;
            _ratingB = ratingB;
            _scoreA = scoreA;
        ...
        */
        ...
        {
            double newRatingA = ratingA + (ELOCalculator.KFACTOR * (scoreA - expectedA));
            double newRatingB = ratingB + (ELOCalculator.KFACTOR * (scoreB - expectedB));
